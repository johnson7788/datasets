...
class MsraNer(datasets.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager):
        ...
        # 不下载，直接使用本地文件
        return [
            datasets.SplitGenerator(name=datasets.Split.TRAIN, gen_kwargs={"filepath": "/Users/admin/git/datasets/myexample/msra/mini.txt"}),
            datasets.SplitGenerator(name=datasets.Split.TEST, gen_kwargs={"filepath": "/Users/admin/git/datasets/myexample/msra/mini.txt"}),
        ]
